...
namespace TM_Comms
{
    public class ModbusDictionary
    {
        ...
        public static Dictionary<TMflowVersions, Dictionary<string, MobusValue>> ModbusData = new Dictionary<TMflowVersions, Dictionary<string, MobusValue>>()
        {
            { TMflowVersions.V1_68_xxxx , new Dictionary<string, MobusValue>()
                {
                    { "Error", new MobusValue { Addr=0x1C21, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Project Running", new MobusValue { Addr=0x1C22, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Project Editing", new MobusValue { Addr=0x1C23, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Project Paused", new MobusValue { Addr=0x1C24, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Get Control", new MobusValue { Addr=0x1C25, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Light", new MobusValue { Addr=0x1C26, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.RW } },
                    { "Safeguard Port A State", new MobusValue { Addr=0x1C27, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "EStop", new MobusValue { Addr=0x1C28, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    ...
                    { "Play/Pause", new MobusValue { Addr=0x1BC0, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Stop", new MobusValue { Addr=0x1BC1, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Stick+", new MobusValue { Addr=0x1BC2, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Stick-", new MobusValue { Addr=0x1BC3, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    ...
                    { "Collab G Sensor", new MobusValue { Addr=0x1FE1, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
            ...
            { TMflowVersions.V1_80_xxxx , new Dictionary<string, MobusValue>()
                {
                    ...
                    { "Robot Base With Tool Ry", new MobusValue { Addr=0x1B91, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Robot Base With Tool Rz", new MobusValue { Addr=0x1B93, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Project Running Speed", new MobusValue { Addr=0x1BBD, Type=MobusValue.DataTypes.Int16, Access=MobusValue.AccessTypes.RW } },
                    { "M/A Mode", new MobusValue { Addr=0x1BBE, Type=MobusValue.DataTypes.Int16, Access=MobusValue.AccessTypes.R } },
                    { "Play/Pause", new MobusValue { Addr=0x1BC0, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Stop", new MobusValue { Addr=0x1BC1, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Stick+", new MobusValue { Addr=0x1BC2, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Stick-", new MobusValue { Addr=0x1BC3, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Power Button (Pressed)", new MobusValue { Addr=0x1BEE, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "M/A Mode (Pressed)", new MobusValue { Addr=0x1BEF, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Play/Pause (Pressed)", new MobusValue { Addr=0x1BF0, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Stop (Pressed)", new MobusValue { Addr=0x1BF1, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Stick+ (Pressed)", new MobusValue { Addr=0x1BF2, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Stick- (Pressed)", new MobusValue { Addr=0x1BF3, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "FreeBot (Pressed)", new MobusValue { Addr=0x1C02, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Error", new MobusValue { Addr=0x1C21, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Project Running", new MobusValue { Addr=0x1C22, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Project Editing", new MobusValue { Addr=0x1C23, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Project Paused", new MobusValue { Addr=0x1C24, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    ...
                    { "Safeguard Port A State", new MobusValue { Addr=0x1C27, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "EStop", new MobusValue { Addr=0x1C28, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Auto Remote Mode Enabled", new MobusValue { Addr=0x1C29, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Auto Remote Mode Active", new MobusValue { Addr=0x1C2A, Type=MobusValue.DataTypes.Coil, Access=MobusValue.AccessTypes.W } },
                    { "Speed Adjustment Enabled", new MobusValue { Addr=0x1C2B, Type=MobusValue.DataTypes.Input, Access=MobusValue.AccessTypes.R } },
                    { "Current Time Year", new MobusValue { Addr=0x1C85, Type=MobusValue.DataTypes.Int16, Access=MobusValue.AccessTypes.R } },
                    { "Current Time Month", new MobusValue { Addr=0x1C86, Type=MobusValue.DataTypes.Int16, Access=MobusValue.AccessTypes.R } },
                    { "Current Time Date", new MobusValue { Addr=0x1C87, Type=MobusValue.DataTypes.Int16, Access=MobusValue.AccessTypes.R } },
                    { "Current Time Hour", new MobusValue { Addr=0x1C88, Type=MobusValue.DataTypes.Int16, Access=MobusValue.AccessTypes.R } },
            ...
            { TMflowVersions.V1_82_xxxx , new Dictionary<string, MobusValue>()
                {
                    { "Current Base No Tool X", new MobusValue { Addr=0x1B59, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Current Base No Tool Y", new MobusValue { Addr=0x1B5B, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Current Base No Tool Z", new MobusValue { Addr=0x1B5D, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    ...
                    { "Stop Node Robot Base With Tool Ry", new MobusValue { Addr=0x1D21, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Stop Node Robot Base With Tool Rz", new MobusValue { Addr=0x1D23, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Current Project", new MobusValue { Addr=0x1E15, Type=MobusValue.DataTypes.String, Access=MobusValue.AccessTypes.RW } },
                    { "TCP Force X", new MobusValue { Addr=0x1E79, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "TCP Force Y", new MobusValue { Addr=0x1E7B, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "TCP Force Z", new MobusValue { Addr=0x1E7D, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "TCP Force 3D", new MobusValue { Addr=0x1E7F, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
            ...
            { TMflowVersions.V1_84_xxxx , new Dictionary<string, MobusValue>()
                {
                    { "Current Base No Tool X", new MobusValue { Addr=0x1B59, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Current Base No Tool Y", new MobusValue { Addr=0x1B5B, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Current Base No Tool Z", new MobusValue { Addr=0x1B5D, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    ...
                    { "TCP Speed RZ", new MobusValue { Addr=0x1EBD, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "TCP Speed", new MobusValue { Addr=0x1EBF, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Joint 1", new MobusValue { Addr=0x1EA7, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Joint 2", new MobusValue { Addr=0x1EA9, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Joint 3", new MobusValue { Addr=0x1EAB, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Joint 4", new MobusValue { Addr=0x1EAD, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Joint 5", new MobusValue { Addr=0x1EAF, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Joint 6", new MobusValue { Addr=0x1EB1, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },

                    { "Torque Average Joint 1", new MobusValue { Addr=0x1EC5, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Average Joint 2", new MobusValue { Addr=0x1EC7, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Average Joint 3", new MobusValue { Addr=0x1EC9, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Average Joint 4", new MobusValue { Addr=0x1ECB, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Average Joint 5", new MobusValue { Addr=0x1ECD, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Average Joint 6", new MobusValue { Addr=0x1ECF, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Min Joint 1", new MobusValue { Addr=0x1ED1, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Min Joint 2", new MobusValue { Addr=0x1ED3, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Min Joint 3", new MobusValue { Addr=0x1ED5, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Min Joint 4", new MobusValue { Addr=0x1ED7, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Min Joint 5", new MobusValue { Addr=0x1ED9, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Min Joint 6", new MobusValue { Addr=0x1EDB, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Max Joint 1", new MobusValue { Addr=0x1EDD, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Max Joint 2", new MobusValue { Addr=0x1EDF, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Max Joint 3", new MobusValue { Addr=0x1EE1, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Max Joint 4", new MobusValue { Addr=0x1EE3, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Max Joint 5", new MobusValue { Addr=0x1EE5, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Torque Max Joint 6", new MobusValue { Addr=0x1EE7, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Joint 1 Speed", new MobusValue { Addr=0x1EE9, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Joint 2 Speed", new MobusValue { Addr=0x1EEB, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Joint 3 Speed", new MobusValue { Addr=0x1EED, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
                    { "Joint 4 Speed", new MobusValue { Addr=0x1EEF, Type=MobusValue.DataTypes.Float, Access=MobusValue.AccessTypes.R } },
